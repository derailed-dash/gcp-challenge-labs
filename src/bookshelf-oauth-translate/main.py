...
app.config.update(
    ...
    SECRET_KEY=secrets.get_secret('flask-secret-key'), # get key from Secret Manager
    MAX_CONTENT_LENGTH=8 * 1024 * 1024,
    ALLOWED_EXTENSIONS=set(['png', 'jpg', 'jpeg', 'gif']),
    CLIENT_SECRETS=json.loads(secrets.get_secret('bookshelf-client-secrets')), # OAuth object
    SCOPES=[
        'openid',
    ...
    EXTERNAL_HOST_URL=os.getenv('EXTERNAL_HOST_URL'), # set publicly accessible OAuth callback URL
